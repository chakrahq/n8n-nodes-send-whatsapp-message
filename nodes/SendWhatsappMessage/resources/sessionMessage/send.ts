...
export const sessionMessageSendDescription: INodeProperties[] = [
	{
		displayName: 'To',
		name: 'to',
		type: 'string',
		...
		description:
			'The end user\'s phone number with the country code and without the preceding "+" character (e.g., 912233223322)',
		routing: {
			send: {
				type: 'body',
				property: 'to',
