...
import { templateMessageSendDescription } from './send';

const showOnlyForTemplateMessage = {
	resource: ['templateMessage'],
};

export const templateMessageDescription: INodeProperties[] = [
	{
	...
	},
	{
		...
		description:
			'The WhatsApp plugin ID where you have connected your WhatsApp account. It\'s a UUID. You can copy it from the plugin details page URL /admin/plugin/d83e1d23-50b8-4d87-8f92-842a0ac516f6. The last part of the URL is the plugin ID',
	},
	{
