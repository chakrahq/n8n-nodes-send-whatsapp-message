...
export const templateMessageSendDescription: INodeProperties[] = [
	{
	...
	},
	{
		...
		description:
			'When you are sending a template message containing a document in the header, you can also optionally pass the filename of the document in this field',
		routing: {
			send: {
				type: 'body',
				property: 'filename',
